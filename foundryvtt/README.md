...
![Version: 14.3.1](https://img.shields.io/badge/Version-14.3.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 13.351.0](https://img.shields.io/badge/AppVersion-13.351.0-informational?style=flat-square)
...
| image.registry | string | `"ghcr.io"` | Registry where to find the image |
