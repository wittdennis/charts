...
![Version: 2.0.0](https://img.shields.io/badge/Version-2.0.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.1.0](https://img.shields.io/badge/AppVersion-v2.1.0-informational?style=flat-square)
...
| resources | object | `{}` |  |
| routes | object | `{"s3":{"api":{"additionalRules":{},"annotations":{},"enabled":false,"filters":[],"hostnames":["s3.garage.ltd","*.s3.garage.ltd"],"labels":{},"matches":[{"path":{"type":"PathPrefix","value":"/"}}],"parentRefs":[]},"web":{"additionalRules":{},"annotations":{},"enabled":false,"filters":[],"hostnames":["*.web.garage.tld"],"labels":{},"matches":[{"path":{"type":"PathPrefix","value":"/"}}],"parentRefs":[]}}}` | Route configuration for Gateway API |
| routes.s3.api | object | `{"additionalRules":{},"annotations":{},"enabled":false,"filters":[],"hostnames":["s3.garage.ltd","*.s3.garage.ltd"],"labels":{},"matches":[{"path":{"type":"PathPrefix","value":"/"}}],"parentRefs":[]}` | Creates route for the S3 api |
| routes.s3.api.additionalRules | object | `{}` | Any custom rule you want to specify |
| routes.s3.api.annotations | object | `{}` | Additional annotations for the HTTPRoute |
| routes.s3.api.enabled | bool | `false` | Flag to control if HTTP route should be created |
| routes.s3.api.filters | list | `[]` | Filter that should be added to the default rule |
| routes.s3.api.hostnames | list | `["s3.garage.ltd","*.s3.garage.ltd"]` | Hostnames of the HTTPRoute |
| routes.s3.api.labels | object | `{}` | Additional labels for the HTTPRoute |
| routes.s3.api.matches | list | `[{"path":{"type":"PathPrefix","value":"/"}}]` | Matches for the default rule |
| routes.s3.api.parentRefs | list | `[]` | Gateway reference that the HTTPRoute should bind against |
| routes.s3.web | object | `{"additionalRules":{},"annotations":{},"enabled":false,"filters":[],"hostnames":["*.web.garage.tld"],"labels":{},"matches":[{"path":{"type":"PathPrefix","value":"/"}}],"parentRefs":[]}` | Route for Web buckets |
| routes.s3.web.additionalRules | object | `{}` | Any custom rule you want to specify |
| routes.s3.web.annotations | object | `{}` | Additional annotations for the HTTPRoute |
| routes.s3.web.enabled | bool | `false` | Flag to control if HTTP route should be created |
| routes.s3.web.filters | list | `[]` | Filter that should be added to the default rule |
| routes.s3.web.hostnames | list | `["*.web.garage.tld"]` | Hostnames of the HTTPRoute |
| routes.s3.web.labels | object | `{}` | Additional labels for the HTTPRoute |
| routes.s3.web.matches | list | `[{"path":{"type":"PathPrefix","value":"/"}}]` | Matches for the default rule |
| routes.s3.web.parentRefs | list | `[]` | Gateway reference that the HTTPRoute should bind against |
